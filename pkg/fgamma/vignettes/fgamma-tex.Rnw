...
setting $\sigma^2 = 1/\alpha$ and $\mu = \alpha \beta$. \\
...
<<alternative>>=
f2 <- fgamma(wage ~ educ + exper + tenure + nonwhite + female + married + numdep |
               educ + exper + tenure, data = Wages)
f3 <- fgamma(wage ~ educ + exper + tenure  + female + married  |
               tenure, data = Wages)
f4 <- fgamma(wage ~ educ + exper + tenure  + female + married  | 1
               , data = Wages)
BIC(f1, f2, f3, f4)
@
...
<<gamlss>>=
library("gamlss")
g1 <- gamlss(wage ~ educ + exper + tenure  + female + married, 
